...
const Button = ({
  ...
  const baseClasses =
    "flex gap-2 justify-center items-center font-medium px-4 py-2 text-center transition focus:outline-none";
  ...
  const buttonTypes = {
    ...
    dropdown:
      "w-full text-leafGreen-600 dark:text-leafGreen-100 px-4 py-2 text-center hover:bg-leafGreen-100 dark:hover:text-leafGreen-600 transition focus:outline-none rounded-none",
  };
...
Button.propTypes = {
  type: PropTypes.oneOf(["primary", "secondary", "delete", "dismissable", "dropdown"]),
