...
function About() {
  ...
  const onJourneyBegin = () => {
    openModal(<AddRecipeModal closeModal={closeModal} />);
  };
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="mt-8 p-6 rounded-lg border border-4 border-dashed border-leafGreen-800 dark:leafGreen-200">
